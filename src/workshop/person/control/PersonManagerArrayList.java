...
public class PersonManagerArrayList { //Person의 정보를 담는 클래스 
	public static void main(String[] args) {
		//ArrayList 객체 생성
		//LinkedList로 변경하는 경우에는 더 많은 부분을 수정해야 하므로 확장성 떨어짐 
		...
		mgr.showPerson(personList2, "김하늘"); //김하늘 이름인 사람의 정보를 보여주기 
	}

	public void showPersons(List<PersonEntity> persons) { //person 리스트 보여주기 
		//Enhanced for Loop
